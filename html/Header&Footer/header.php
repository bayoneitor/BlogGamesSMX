...
<head>
    ...
    <title>BlogGames - Leer Mas</title>
...
<body>
    ...
    <nav style="background-color: #6351ce;" class="mb-1 navbar sticky-top navbar-expand-lg navbar-dark">
        <a href="../../index.php" class="navbar-brand">BlogGames</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="../../index.php">Principio</a>
                </li>
                <li class="nav-item">
            ...
            if (isset($_SESSION['userId'])) {
                ...
                echo ' <a class="dropdown-item" href="../../user/configuration.php">Configuración</a>
