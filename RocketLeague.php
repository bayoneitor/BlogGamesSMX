<?php
require 'includes/Header&Footer/header_rl.php';
?>
...
<section class="my-5">
    ...
    <!-- Introducion -->
    <h2 class="h1-responsive font-weight-bold text-center my-5" style="padding-top:20px;">Todos los Posts de <b>Rocket League</b></h2>
    <!-- Section description -->
    <p class="text-center w-responsive mx-auto mb-5">Aquí podras encontrar los posts relacionados con Rocket League</p>

    <?php
    require 'includes/dbh.inc.php';


    $sql = "SELECT * FROM post WHERE category_post='Rocket League' ORDER BY id_post DESC ";
